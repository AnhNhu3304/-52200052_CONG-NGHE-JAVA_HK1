...
public class DemoApplication {
    ...
    public CommandLineRunner commandLineRunner() {
        return args -> {
            ...
            System.out.println("Danh sách sinh viên có tuổi từ 20 trở lên:");
            studentsByAge.forEach(System.out::println);

            // 2. Đếm số lượng sinh viên có điểm IELTS bằng 7.0
            long countByIeltsScore = studentRepository.countByIeltsScore(7.0);
            ...
            List<Student> studentsByName = studentRepository.findByNameContainingIgnoreCase("Van");
